...
export const CustomImageContainerWithBorderRadius = styled(Box)(({ theme }) => ({
...
export const CustomColouredTypographySubtitle = styled(Typography)(({ theme }) => ({
  marginTop: '0.563rem',
  textTransform: 'none',
...
export const CloseIconWrapper = styled('div')(({ theme, right, languageDirection }) => ({
  top: 0,
...
export const CustomStackFullWidth = styled(Stack)(({ theme, marginBottom, marginTop }) => ({
  width: '100%',
  marginBottom: marginBottom,
  marginTop: marginTop,
}));
export const CustomBoxWithSpacing = styled(Box)(({ theme, marginTopBottom }) => ({
  width: '100%',
...
export const CustomTextFieldContainer = styled(Box)(({ theme, background, noheight }) => ({
  width: '100%',
...
export const CustomOverLay = styled(Stack)(({ theme, hover, border_radius }) => ({
...
export const EmptyMessageContainer = styled(CustomStackFullWidth)(({ theme }) => ({
  height: '20vh',
  width: '25vw',
}));
...
export const CustomImageContainerStyled = styled(Box)(
  ({
    ...
    '& img': {
      ...
      border: `${borderWidth ? borderWidth : 0} solid ${borderColor}`,
...
export const CustomListItem = styled(ListItem)(({ theme, display, cursor }) => ({
  display: display,
...
export const SliderCustom = styled(Stack)(
  ({ theme, languageDirection, gap, paddingBottom, isCenter, bgColor }) => ({
    alignItems: 'center',
    paddingY: '1rem',
    backgroundColor: bgColor ? bgColor : '#fff0',
    '& .slick-slider': {
      '& .slick-list': {
        '& .slick-track': {
...
export const CustomCouponCard = styled(Card)(({ theme }) => ({
  padding: '.5rem',
  boxShadow: '0px 0px 2px rgba(0, 0, 0, 0.1), 0px 5px 10px rgba(0, 0, 0, 0.05)',
  position: ' relative',
  '&::after': {
    position: ' absolute',
    content: '""',
