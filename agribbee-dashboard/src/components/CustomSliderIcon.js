...
import { LeftArrowStyle, RightArrowStyle } from '@/sections/home/HomeStyle';
import {
  CustomIconButton,
  CustomSideOverLay,
} from '@/sections/home/auctions-section/FeaturedAuction.style';

export const HandleNext = ({ onClick, className, overLay }) => (
  <>
    {overLay ? (
      <CustomSideOverLay left="unset" right="0" isdisabled={className?.includes('slick-disabled')}>
        <RightArrowStyle
          right="1%"
