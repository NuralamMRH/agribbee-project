...
export const MarketsMapSectionWrapper = styled(Stack)(
  ({ theme, mapBg, mapHeight, isZoomed }) => ({
    backgroundColor: mapBg ? mapBg : "#fff0",
    backgroundRepeat: "no-repeat",
    borderRadius: "16px",
    overflow: "hidden",
    position: "relative",
    ...
    [theme.breakpoints.down("sm")]: {
      height: mapHeight ? mapHeight : "570px",
    },
    ...
    "& svg": {
      ...
      "& path:hover": {
        fill: theme.palette.customColor.fifteen,
      },
    },
