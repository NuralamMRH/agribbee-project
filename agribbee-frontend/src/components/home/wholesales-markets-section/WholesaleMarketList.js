      ...
      <Grid alignItems="start">
        ...
        {region1markets?.data?.markets?.length > 0 ? (
          <Grid
            sx={{
              display:
                region1markets?.data?.markets?.length > 5 ? "flex" : "column",
            }}
            flexWrap={"wrap"}
          >
            {region1markets?.data?.markets?.map((item) => (
              <Grid
                item
                key={item._id}
                xs={12}
      ...
      <Grid alignItems="start">
        ...
        {region2markets?.data?.markets?.length > 0 ? (
          <Grid
            sx={{
              display:
                region2markets?.data?.markets?.length > 5 ? "flex" : "column",
            }}
            flexWrap={"wrap"}
          >
            {region2markets?.data?.markets?.map((item) => (
              <Grid
                item
                key={item._id}
                xs={12}
      ...
      <Grid alignItems="start">
        ...
        {region3markets?.data?.markets?.length > 0 ? (
          <Grid
            sx={{
              display:
                region3markets?.data?.markets?.length > 5 ? "flex" : "column",
            }}
            flexWrap={"wrap"}
          >
            {region3markets?.data?.markets?.map((item) => (
              <Grid
                xs={12}
                md={4}
                sx={{ display: "flex", gap: "5px", margin: "10px 0" }}
...
export default WholesaleMarketList;
