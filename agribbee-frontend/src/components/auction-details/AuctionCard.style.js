...
export const SellerDetailsNavButton = styled(Button)(
  ({
    theme,
    color,
    background,
...
export const AuctionTitleTypography = styled(Typography)(
...
export const AuctionTitleTypographyDetails = styled(Typography)(
  ({ theme }) => ({
    // eslint-disable-next-line no-mixed-operators
    fontSize: "20px",
    padding: 0,
...
export const AuctionSubTitleTypography = styled(Typography)(({ theme }) => ({
  // eslint-disable-next-line no-mixed-operators
  fontSize: "14px",
  padding: 0,
  lineHeight: 1.3,
...
export const CustomAuctionCard = styled(Card)(({ theme }) => ({
  // eslint-disable-next-line no-mixed-operators
  borderRadius: "10px",
  position: "relative",
  margin: "0 auto",
...
export const CustomAuctionCardNew = styled(Card)(
  ({
    theme,
    width,
    maxwidth,
...
export const SellerDiscountStack = styled(Stack)(
  ({ theme, languageDirection }) => ({
    //maxWidth: '140px',
    width: "auto",
    position: "absolute",
    ...
    padding:
      languageDirection === "rtl" ? "5px 5px 5px 14px" : "5px 6px 5px 24px",
    borderRadius:
      languageDirection === "rtl" ? "37px 0px 0px 0px" : "38px  0px 0px  0px",
    [theme.breakpoints.down("sm")]: {
      fontSize: "10px",
    },
  })
);
export const CustomSellerCardCoupon = styled(Stack)(
  ({ theme, languageDirection }) => ({
    position: "absolute",
    bottom: 0,
    left: "unset",
    ...
    zIndex: 9,
    padding:
      languageDirection === "rtl" ? "5px 5px 5px 14px" : "5px 10px 5px 12px",
    borderRadius:
      languageDirection === "rtl" ? "19px 0px 0px 0px" : "20px  0px 0px  0px",
    fontWeight: 500,
    fontSize: "13px",
...
export const CustomChip = styled(Chip)(
  ({ theme, background, discount, campaign }) => ({
    ...
    "& .MuiChip-label": {
      backgroundColor: background ? background : theme.palette.customColor.two,
      color: theme.palette.whiteContainer.main,
