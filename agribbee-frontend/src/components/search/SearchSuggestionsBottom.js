                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      />
                      <Typography color={theme.palette.neutral[1200]}>
                        {item}
                      </Typography>
                    </Stack>
                    <IconButton onClick={() => handleDeleteAble(item)}>
                      <ClearIcon
                        style={{
                          width: "16px",
                          height: "16px",
            ...
            {inputValue === "" ? (
              <>
                {token && (
                  <>
                    {historyHandler()}
                    <SuggestedCuisines routeHandler={routeHandler} />
                ...
                {data && (
                  <Stack spacing={1} sx={{ paddingTop: "10px" }}>
                    ...
                    <Stack
                      ...
                      gap="10px"
                    >
                      <CustomColouredTypography sx={{ fontSize: "14px" }}>
                        {t("Auctions")}
                      </CustomColouredTypography>
