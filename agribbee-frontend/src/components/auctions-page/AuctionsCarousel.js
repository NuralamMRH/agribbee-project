...
const AuctionsCarousel = ({ auctions, isLoading }) => {
  ...
  return (
    <>
      <Grid
        container
        paddingTop={auctions?.length > 0 && { xs: "0.5rem", sm: "1.9rem" }}
      >
        <CustomGridWithBgColor
          foodsize={auctions?.length}
        ...
        >
          <CustomStackFullWidth justifyContent="right">
            {!isLoading ? (
                    ...
                    {auctions?.map((auction) => {
                      return (
                        <AuctionCard
                          ...
                          pageType={"current_auction"}
                        />
                      );
                    })}
                    {/*{foodCount(auctions) > 5 && (*/}
              ...
              <Typography>{t("No any auctions found")}</Typography>
            ) : null}
          </CustomStackFullWidth>
        </CustomGridWithBgColor>
      </Grid>
...
export default memo(AuctionsCarousel);
