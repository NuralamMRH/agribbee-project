...
const KioskBoxCard = (props) => {
  ...
  const logo = `${kioskImagePath}/${image}`;
  ...
  return (
    <Stack
      onClick={() => handleClickOnKiosk(item)}
      className={className}
      height={"100%"}
    >
      <CustomPaperBigCard
        ...
        <CustomStackFullWidth spacing={1}>
          <Stack sx={{ overflow: "hidden", position: "relative" }}>
            <Box
              sx={{
                width: "100%",
                height: { sm: "150px", md: "180px", lg: "200px" },
