...
// Add 1 day to the current date and format it as 'YYYY/MM/DD'
let nextday = moment(currentDate).add(1, 'days').format('YYYY/MM/DD')

// Get the name of the day for the current date (e.g., 'Monday')
let today = moment(currentDate).format('dddd')

// Get the name of the day for the next day (e.g., 'Tuesday')
let tomorrow = moment(nextday).format('dddd')

// Get the current date and time in ISO 8601 format (e.g., '2024-08-14T10:30:45Z')
var CurrentDatee = moment().format()

// Extract the time portion in the format 'HH:mm' from the current date and time
