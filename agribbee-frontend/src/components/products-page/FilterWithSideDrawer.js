...
import { PrimaryButton } from "./AuctionTabContainer";
    ...
    <RTL direction={languageDirection}>
        ...
        {isNetworkCalling || isLoading ? (
          ...
          <Stack direction="row" spacing={1} alignItems="center">
            <CustomImageContainer
              src={
                globalTabType === "products" ? foodCount.src : result_count.src
              }
              width="26px"
              height="26px"
            />
      ...
      >
        <Stack direction="row" spacing={1} justifyContent="flex-end">
          ...
          <FilterButton id="fade-button" handleClick={handleDropClick} />
        </Stack>
        <Popover
