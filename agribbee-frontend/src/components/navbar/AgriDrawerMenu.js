...
const AgriDrawerMenu = ({ zoneid, cartListRefetch }) => {
            ...
            <>
              ...
              >
                <ListItemText
                  ...
                  onClick={() => handleRoute("cho-dau-moi")}
                />
              </ListItemButton>
              <ListItemButton
                sx={{
  ...
  return (
    <Box>
      ...
      <IconButton
        ...
        sx={{
          color: (theme) => theme.palette.whiteText.main,
          paddingRight: "0px",
