...
export const CustomDrawer = styled(Drawer)(({ theme, bgColor }) => ({
  zIndex: 1200,
  "& .MuiDrawer-paper": {
    maxWidth: "265px",
    width: "100%",
...
export const AppBarStyle = styled(({ scrolling, isSmall, ...rest }) => (
  <AppBar {...rest} />
...
export const NavLinkStyle = styled(Stack)(({ theme, languageDirection }) => ({
  color: `${theme.palette.mode === "dark" ? "#fff" : "#f1f1f1"}`,
...
export const TopBarButton = styled(Button)(
  ({ theme, formMobileMenu, background }) => ({
    padding: formMobileMenu === "true" ? "7px 5px" : "7px 0px",
    color: theme.palette.neutral[100],
    backgroundColor: background || theme.palette.navbarBg,
    minWidth: "40px",
    maxWidth: "200px",
  })
);
