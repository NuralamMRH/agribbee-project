    ...
    <Stack direction="row" spacing={2.5}>
      <>
        <NavLinkStyle
          ...
          sx={{
            cursor: "pointer",
            paddingInlineEnd: languageDirection === "rtl" && "1.5rem",
          }}
        >
        ...
        >
          <Typography fontSize="14px">{t("Buy")}</Typography>
        </NavLinkStyle>
        <NavLinkStyle
        ...
        >
          <Typography fontSize="14px">{t("Auction")}</Typography>
        </NavLinkStyle>
        <NavLinkStyle
          onClick={() => {
            router.push("/cho-cau-moi")
            dispatch(setHandleHomePage(false))
          }}
          underline="none"
          languageDirection={languageDirection}
        ...
        >
          <Typography fontSize="14px">{t("Chợ Đầu Mối")}</Typography>
        </NavLinkStyle>
        <NavLinkStyle
          onClick={handleClick}
          underline="none"
        ...
        >
          <Typography fontSize="14px">{t("Thương Lái")}</Typography>
        </NavLinkStyle>
        <NavLinkStyle
          onClick={handleClick}
          underline="none"
        ...
        >
          <Typography fontSize="14px">{t("OCOP")}</Typography>
        </NavLinkStyle>
        <NavLinkStyle
          onClick={handleClick}
          underline="none"
        ...
        >
          <Typography fontSize="14px">{t("Contact")}</Typography>
        </NavLinkStyle>
