      ...
      >
        <Grid container spacing={2}>
          <Grid item sm={12} xs={12} md={4}>
            <WalletBox>
              <CustomStackFullWidth spacing={0.5} sx={{ flexWrap: "wrap" }}>
                ...
                >
                  {profileDataLoading ? (
                    <Skeleton variant="text" width={150} height="50px" />
                  ) : (
              ...
              >
                <ListItem>
                  <Typography fontSize="13px" fontWeight="400">
                    {t("Convert your loyalty point to wallet money.")}
                  </Typography>
                </ListItem>
                <ListItem>
                  <Typography fontSize="13px" fontWeight="400">
                    {t("Minimum")} {t(global?.minimum_point_to_transfer)}{" "}
                    {t("points required to convert into currency")}
                  </Typography>
                </ListItem>
              </List>
