...
const EcommercePageSearch = ({}) => {
  ...
  const banner_bg = `${host}/static/banners/ecommerce-banner.png`;
      ...
      >
        ...
        >
          <Typography
            ...
            marginBottom={"10px"}
          >
            {t(`NÔNG SẢN CHỢ ĐẦU MỐI (E-Commerce Market Place)`)}
          </Typography>
          {handleShowSearch()}

          <CustomContainer>
            <EcommerceCategories mainBg={"#fff0"} categoryBg={"#fff0"} />
          </CustomContainer>
        </Grid>
      </CustomStackFullWidth>
    </CustomStackFullWidth>
...
export default EcommercePageSearch;
