...
import ImportedFoodSourcingLayout from "./layouts/imported-food-sourcing/ImportedFoodSourcingLayout";

const HomePage = React.lazy(() => import("./gurbage/home/HomePage"));
const ImportedFoodSourcing = React.lazy(() =>
  import("./gurbage/imported-food-sourcing/ImportedFoodSourcing")
);
...
const AllRoutes = () => {
  return (
    <>
      ...
      <Routes>
        <Route
          path="/imported-food-sourcing"
          element={<ImportedFoodSourcingLayout />}
        >
          <Route
            path="imported-food-sourcing"
            element={<ImportedFoodSourcing />}
          />
        </Route>
      </Routes>
      ...
      <Routes>
        <Route path="/admin" element={<DashboardLayout />}>
          ...
          <Route path="components/tables" element={<CustomTables />} />
          <Route path="components/alerts" element={<CustomAlerts />} />
          <Route path="components/toasters" element={<CustomToasters />} />
          <Route path="components/dialogs" element={<CustomDialogs />} />
          <Route
          ...
          />
          <Route path="/admin/service-zones/" element={<ServiceZones />} />
          <Route
          ...
          />
          <Route path="services/service-list" element={<ServicesChildOne />} />
