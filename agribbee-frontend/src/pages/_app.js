...
function App({ Component, pageProps, emotionCache = clientSideEmotionCache }) {
  ...
  if (typeof window !== "undefined") {
    if (!zoneid) zoneid = localStorage.setItem("zoneid", "70-74");
              ...
              {(value) => (
                <ThemeProvider
                  theme={createTheme({
                    ...
                    mode: "light", //value.settings.theme
                  })}
                >
                  <CssBaseline />
                  <Toaster />
                  ...
                  <WrapperForApp>
                    ...
                    <Box
                      sx={{
                        height: "100%",
                        mt: {
                          xs: router.pathname === "/home" ? "2.5rem" : "2rem",
                          md: "4rem",
                        },
                      }}
                    >
                    ...
                    {viewFooter && (
                      <Footer languageDirection={value?.settings?.direction} />
                    )}
                  </WrapperForApp>
                </ThemeProvider>
              )}
