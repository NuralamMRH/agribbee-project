  ...
  return (
    <SafeAreaView style={[styles.area]}>
      <View style={[styles.container]}>
        {Platform.OS === "android" ? (
          <RenderHeader title={"YC CẬP CẢNG"} />
        ) : (
          <Stack.Screen
            options={{
              title: "YC CẬP CẢNG",
        ...
        <ScrollView>
          <SocialButtonV2
            ...
            onPress={() => router.push("/request-dock/port-list")}
            title={"THÔNG TIN CẢNG CÁ"}
            iconStyles={{ tintColor: COLORS.primary }}
          />
          <SocialButtonV2
            icon={icons.fluentTaskList}
            onPress={() => router.push("/request-dock/request-departure")}
            title={"YÊU CẦU RỜI CẢNG"}
            iconStyles={{ tintColor: COLORS.primary }}
          />
          <SocialButtonV2
            icon={icons.fluentTaskList}
            onPress={() => router.push("/request-dock/doc-list")}
