  ...
  return (
    <SafeAreaView style={[styles.area]}>
      <View style={[styles.container]}>
        {Platform.OS === "android" ? (
          <RenderHeader title={"NK KHAI THÁC"} />
        ) : (
          <Stack.Screen
            options={{
              title: "NK KHAI THÁC",
        ...
        <ScrollView>
          <SocialButtonV2
            ...
            onPress={() => router.push("/fishing-log/fresh-catch-list")}
            title={"Fresh Catch Log Record"}
            iconStyles={{ tintColor: COLORS.primary }}
          />
          <SocialButtonV2
            icon={icons.fluentTaskList}
            onPress={() => router.push("/fishing-log/daily-catch-report")}
            title={"Daily Catch Report by Trip"}
            iconStyles={{ tintColor: COLORS.primary }}
          />
          <SocialButtonV2
            icon={icons.fluentTaskList}
            onPress={() => router.push("/fishing-log/productivity-catch")}
            title={"Productivity Catch Report by Region"}
            iconStyles={{ tintColor: COLORS.primary }}
          />
          <SocialButtonV2
            icon={icons.fluentTaskList}
            onPress={() => router.push("/fishing-log/catch-report-by-vessel")}
            title={"List of Catch Reports by Vessel"}
            iconStyles={{ tintColor: COLORS.primary }}
          />
        </ScrollView>
      </View>
