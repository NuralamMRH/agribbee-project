...
const navConfig = [
  ...
  // ----------------------------------------------------------------------
  {
    ...
    //   { title: 'auctions', path: PATH_DASHBOARD.general.booking, icon: ICONS.booking },
    //   { title: 'analytics', path: PATH_DASHBOARD.general.analytics, icon: ICONS.analytics },
    //   { title: 'app', path: PATH_DASHBOARD.general.app, icon: ICONS.dashboard, roles: ['admin'] },
  ...
  // ----------------------------------------------------------------------
  {
    ...
    items: [
      ...
      {
        title: 'request dock',
        path: PATH_DASHBOARD.eCommerce.root.list,
        icon: ICONS.requestdock,
        children: [
          { title: 'list', path: PATH_DASHBOARD.eCommerce.list },
          { title: 'new', path: PATH_DASHBOARD.eCommerce.new },
        ],
      },
      ...
      //   icon: ICONS.logbook,
      //   children: [
      //     { title: 'bidding', path: PATH_DASHBOARD.auction.bidding },
      //     { title: 'inventory', path: PATH_DASHBOARD.auction.list },
      //     { title: 'create', path: PATH_DASHBOARD.auction.new },
      //     { title: 'payment', path: PATH_DASHBOARD.auction.payment },
      //   ],
      // },
      ...
      // {
      //   title: 'order request',
      //   path: PATH_DASHBOARD.orderRequest.root,
      //   icon: ICONS.invoice,
      //   children: [
      //     { title: 'list', path: PATH_DASHBOARD.orderRequest.list },
      //     { title: 'details', path: PATH_DASHBOARD.orderRequest.demoView },
      //     { title: 'create', path: PATH_DASHBOARD.orderRequest.new },
      //     { title: 'edit', path: PATH_DASHBOARD.orderRequest.demoEdit },
      //   ],
      // },
      ...
      {
        title: 'vessel',
        path: PATH_DASHBOARD.vessel.root,
        icon: ICONS.settings,
        roles: ['admin', 'vip', 'vp'],
        children: [
          { title: 'profile', path: PATH_DASHBOARD.vessel.profile },
          { title: 'cards', path: PATH_DASHBOARD.vessel.cards },
          { title: 'list', path: PATH_DASHBOARD.vessel.list },
          { title: 'create', path: PATH_DASHBOARD.vessel.new },
          { title: 'edit', path: PATH_DASHBOARD.vessel.demoEdit },
          { title: 'account', path: PATH_DASHBOARD.vessel.account },
        ],
      },
      // USER
      {
