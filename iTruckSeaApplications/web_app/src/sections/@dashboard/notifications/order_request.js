...
OrderRequestDialog.propTypes = {
  open: PropTypes.bool,
  onClose: PropTypes.func,
  notificationData: PropTypes.object,
};

export default function OrderRequestDialog({ open, onClose, notificationData }) {
            ...
            <Card sx={{ p: 3 }}>
              <Stack spacing={2}>
                <Typography variant="h3">
                  {fCurrency(notificationData?.data?.newOrder?.order_amount)}
                </Typography>
                ...
                <Stack direction="row" justifyContent="space-between">
                  ...
                  <Typography variant="body2">{fCurrency(7985)}</Typography>
                </Stack>
              </Stack>
            </Card>
          </Stack>
